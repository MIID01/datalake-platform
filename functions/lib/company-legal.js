...
const COMPANY = {
  ...
  mol_number: "1-4400108", // MOL establishment number (رقم مكتب العمل) for WPS/SIF/GOSI.
  // CEO-provided 2026-06-23 — real value, enables WPS/GOSI payroll file generation.
...
// carry a hand-typed legal string). The website is emitted as a full https URL —
// a bare "www.datalake.sa" hostname is scored "suspicious" by bank/SAMA mail
// gateways (Proofpoint/Mimecast), which flagged a client interview invite.
const LEGAL_EMAIL_FOOTER = `${LEGAL_FOOTER_EN} · https://www.${COMPANY.domain}`;
