    ...
    busboy.on("finish", async () => {
      try {
        ...
        await docRef.set({
          ...
          cv_path: cvPath,
          // Recruiting-campaign attribution (channel-agnostic: LinkedIn, Google Ads,
          // referral, …). Carried from the careers-link UTM params; defaults to WEBSITE.
          source_channel: fields.utm_source ? String(fields.utm_source).toUpperCase() : "WEBSITE",
